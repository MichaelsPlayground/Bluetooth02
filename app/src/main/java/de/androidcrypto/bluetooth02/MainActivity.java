...
public class MainActivity extends AppCompatActivity {
    ...
    Button btn20SimpleExample;

    BluetoothManager bluetoothManager;
    BluetoothAdapter bluetoothAdapter;
    BluetoothDevice bluetoothDevice; // is filled by AcceptThread
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn20SimpleExample = findViewById(R.id.btn20SimpleExample);
...
/*
    ...
    // this is called from AcceptThread when there is a connection
